                        ...
                        @if ($answers)
                            <div>
                                ...
                                <div class="flex items-center gap-6 mt-6">
                                    ...
                                    <a href="" class="bg-hijau rounded-xl py-1.5 text-white text-base flex items-center justify-center gap-2 w-full">
                                        Lanjutkan
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                            <path d="M10.5 17L15.5 12L10.5 7" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
