    ...
    <div class="bg-white rounded-xl p-8">
        ...
        <form method="POST" action="{{ route('tugas-answer.store') }}" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <div id="dropzone"
                        class="border-2 rounded-xl border-hijau-400 border-dashed p-4 cursor-pointer h-32 flex flex-col items-center justify-center gap-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path d="M12 15V2M12 2L15 5.5M12 2L9 5.5" stroke="#231F20" stroke-width="1.5"
                ...
                <input type="text" id="link" name="link" value="{{ old('link') }}" placeholder="Masukkan Link"
                    autofocus
                    class="w-full px-4 py-2 border-2 outline-none border-hijau-400 rounded-xl focus:border-hijau focus:border-2">
                <textarea name="catatan" id="catatan" rows="6" value="{{ old('catatan') }}" placeholder="Masukkan Catatan"
            ...
            <div class="flex items-center p-4 md:p-5 rounded-b gap-4 justify-end w-full">
                <a href="{{ route('tugas.show', $subtugases->tugas->id) }}"
                    class="block py-2.5 px-5 ms-3 text-sm font-medium focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-100">Batal</a>
                <button type="submit"
