            ...
            @csrf
                <div class="p-4 md:p-5 space-y-9">
                    <div class="flex flex-col gap-8">
                        ...
                        <input type="text" id="mata_pelajaran" name="mata_pelajaran" value="{{ old('mata_pelajaran') }}" placeholder="Masukkan Mata Pelajaran" required class="w-full px-4 py-2 border-2 outline-none border-hijau-400 rounded-xl focus:border-hijau focus:border-2">
                        ...
                        <textarea name="capaian" id="capaian" rows="6" value="{{ old('capaian') }}" placeholder="Masukkan Capaian" class="w-full px-4 py-2 border-2 outline-none border-hijau-400 rounded-xl focus:border-hijau focus:border-2"></textarea>
                    </div>
                </div>
                <!-- Modal footer -->
