                ...
                <form method="POST" action="{{ route('register') }}" class="w-full">
                    <div class="flex flex-col gap-5 my-6">
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="Masukkan alamat email" required autofocus class="w-full px-4 py-2 border-2 outline-none border-hijau-400 rounded-xl focus:border-hijau focus:border-2">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="kelas" name="kelas" value="{{ old('kelas') }}" placeholder="Masukkan kelas" required class="w-full px-4 py-2 border-2 outline-none border-hijau-400 rounded-xl focus:border-hijau focus:border-2">
                        </div>
                        <div>
                            <label for="absen" class="block mb-2 font-semibold">No. Absen</label>
                            <input type="text" id="absen" name="absen" value="{{ old('absen') }}" placeholder="Masukkan no. absen" required class="w-full px-4 py-2 border-2 outline-none border-hijau-400 rounded-xl focus:border-hijau focus:border-2">
                        </div>
                        <div>
                    ...
                    <div class="flex justify-center mb-4">
                        <button type="submit" class="px-24 py-4 text-lg font-semibold text-white bg-hijau rounded-xl">Daftar</button>
                    </div>
                    <p class="block text-center underline text-hijau">Sudah Punya Akun? <a href="{{ route('login') }}">Masuk</a></p>
                </form>
            </div>
        </div>
    </main>
