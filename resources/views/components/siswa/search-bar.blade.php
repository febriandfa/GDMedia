<div class="w-[30rem] h-10 relative rounded-xl overflow-hidden">
    <label for="search">
        <svg class="absolute top-1.5 right-2.5 z-[5]" xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
    ...
    <input type="text" id="search" name="search" placeholder="Cari..." class="w-[30rem] h-10 border-0 outline-none focus:outline-none rounded-xl pr-16">
